					...
					<div class="card h-100 shadow-sm border-0" style="background-color: #d1e7dd;">
						<div class="card-body py-4 text-center">
							...
							<div class="d-grid gap-2">
								...
								<a href="TestScores.action" class="btn btn-outline-primary bg-white border-0 py-2">成績参照</a>
							</div>
						</div>
					</div>
				</div>
                    ...
                    <div class="card h-100 shadow-sm border-0" style="background-color: #f8d7da;">
                        <div class="card-body d-flex align-items-center justify-content-center py-5">
                            <a href="StudentList.action"
                               class="btn btn-link text-decoration-none fs-4 fw-bold text-primary">
                                学生管理
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="card-body py-4 text-center">
                            ...
                            <div class="d-grid gap-2">
                                <a href="TestRegist.action"
                                   class="btn btn-outline-primary bg-white border-0 py-2">
                                   成績登録
                                </a>
                                ...
                                <a href="TestDelete.action"
                                   class="btn btn-outline-danger bg-white border-0 py-2">
                                   成績削除
                                </a>
                            </div>
                        </div>
