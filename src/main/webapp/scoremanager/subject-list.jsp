                ...
                <table class="table">
                    ...
                    <c:forEach var="subject" items="${sList}">
                        <tr>
                            <td>${subject.cd}</td>
                            <td>${subject.name}</td>
                            <td><a href="SubjectUpdate.action?cd=${subject.cd}" class="btn btn-link text-decoration-none fs-4 fw-bold text-primary">更新</a></td>
                            <td><a href="SubjectDelete.action?cd=${subject.cd}" class="btn btn-link text-decoration-none fs-4 fw-bold text-primary">削除</a></td>
                        </tr>
                    </c:forEach>
                </table>
            </c:when>
